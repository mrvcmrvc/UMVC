...
public class UIMenuTweenBehaviour : UIMenuAnimationBehaviourImplementer
{
    [Tooltip("Use Intro tweeners as outro tweeners as well")]
    public bool UseIntroTweenersAsOutro;

    public List<MMUITweener> IntroTweenList;
    public List<MMUITweener> OutroTweenList;

    private int _activeTweenCount;

    private Action _callback;
    private List<MMUITweener> _activeTweenList;
